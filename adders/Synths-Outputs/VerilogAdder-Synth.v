...
// Date      : Wed Dec 13 19:59:20 2023
/////////////////////////////////////////////////////////////


module VerilogAdder_DW01_add_0 ( A, B, CI, SUM, CO );
  input [32:0] A;
  input [32:0] B;
  output [32:0] SUM;
  input CI;
...
module VerilogAdder_Synth ( a, b, Cin, Overflow, S, Cout );
  input [31:0] a;
  input [31:0] b;
  output [31:0] S;
  input Cin;
  ...
  VerilogAdder_DW01_add_0 add_1_root_add_9_2 ( .A({1'b0, a}), .B({1'b0, b}), 
        .CI(Cin), .SUM({Cout, S}) );
  NOR2X0 U6 ( .IN1(n5), .IN2(n6), .QN(Overflow) );
  XOR2X1 U7 ( .IN1(b[31]), .IN2(a[31]), .Q(n6) );
  XNOR2X1 U8 ( .IN1(a[31]), .IN2(S[31]), .Q(n5) );
endmodule
